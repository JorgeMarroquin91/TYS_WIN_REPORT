...
{
    public partial class TysWinReportFrmConteoNuevaClasificacion : Form
    {
        ...
        public TysWinReportFrmConteoNuevaClasificacion()
        {
            InitializeComponent();
        }
        ...
        private void btnGenerar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var reportDataSource = new ReportDataSource(name: "DataSet1", dataSourceValue: (DataTable)(new SP_ConteoPorDiaYClasificacionTableAdapter().GetDataByConteoNuevaClasificacion(estacionQuery, fechaInicio.ToString("yyyy/MM/dd"), fechaFin.ToString("yyyy/MM/dd"))));
        ...
        private void inicializarParametros(ReportParameter[] parametros)
        {
            ...
            parametros[17] = new ReportParameter("descripcion", "Conteo Vehicular Nueva Clasificación");
