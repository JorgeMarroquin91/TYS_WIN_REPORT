...
{
    public partial class TysWinReportFrmConteoPorPeriodoYClasificacion : Form
    {
        ...
        public TysWinReportFrmConteoPorPeriodoYClasificacion()
        {
            InitializeComponent();
        }
        ...
        private void btnGenerar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var reportDataSource = new ReportDataSource(name: "DataSet1", dataSourceValue: (DataTable)(new SP_ConteoPorDiaYClasificacionTableAdapter().GetDataConteoVehicularPorPeriodoYClasificacion (estacionQuery, fechaInicio.ToString("yyyy/MM/dd"), fechaFin.ToString("yyyy/MM/dd"))));
