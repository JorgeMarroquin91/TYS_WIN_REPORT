...
{
    partial class TysWinReportFrmConteoVehicularPorDiaPorHora
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            Load += this.TysWinReportFrmConteoVehicularPorDiaPorHora_Load;
            SizeChanged += this.TysWinReportFrmConteoVehicularPorDiaPorHora_SizeChanged;
            ResumeLayout(false);
            PerformLayout();
        }
