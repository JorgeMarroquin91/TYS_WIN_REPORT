...
{
    public partial class TysWinReportFrmConteoVehicularPorDiaPorHora: Form
    {
        ...
        public TysWinReportFrmConteoVehicularPorDiaPorHora()
        {
            InitializeComponent();
        }
        ...
        private void btnGenerar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var reportDataSource = new ReportDataSource(name: "DataSet1", dataSourceValue: (DataTable)(new SP_ConteoPorDiaYClasificacionTableAdapter().GetDataConteoVehicularPorDiaPorHora(estacion.nombreEstacion + fecha.Year, fecha.ToString("yyyy/MM/dd"))));
        ...
        private void inicializarParametros(ReportParameter[] parametros)
        {
            ...
            parametros[17] = new ReportParameter("descripcion", "Conteo Vehicular por Día y Hora");
