...
{
    public partial class TysWinReportFrmConteoVehicularPorPeriodo : Form
    {
        ...
        public TysWinReportFrmConteoVehicularPorPeriodo()
        {
            InitializeComponent();
        }

        private void TysWinReportFrmConteoVehicularPorPeriodo_Load(object sender, EventArgs e)
        {
            this.listarEstacion();
            this.limitDate();
        ...
        private void btnGenerar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var reportDataSource = new ReportDataSource(name: "DataSet1", dataSourceValue: (DataTable)(new SP_ConteoPorDiaYClasificacionTableAdapter().GetDataConteoVehicularPorPeriodo(estacionQuery, fechaInicio.ToString("yyyy/MM/dd"), fechaFin.ToString("yyyy/MM/dd"))));
        ...
        private void TysWinReportFrmConteoVehicularPorPeriodo_SizeChanged(object sender, EventArgs e)
        {
            this.reportViewer1.Width = this.Width - 60;
            this.reportViewer1.Height = this.Height - 125;
        }
        ...
        private void inicializarParametros(ReportParameter[] parametros)
        {
            ...
            parametros[16] = new ReportParameter("titulo", "Dia");
            parametros[17] = new ReportParameter("descripcion", "Conteo Vehicular por Periodo y Clasificación");
