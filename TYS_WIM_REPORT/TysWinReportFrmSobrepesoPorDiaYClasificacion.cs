...
{
    public partial class TysWinReportFrmSobrepesoPorDiaYClasificacion : Form
    {
        ...
        public TysWinReportFrmSobrepesoPorDiaYClasificacion()
        {
            InitializeComponent();
        }
        ...
        private void btnGenerar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var reportDataSource = new ReportDataSource(name: "DataSet1", dataSourceValue: (DataTable)(new SP_ConteoPorDiaYClasificacionTableAdapter().GetDataBySobrepesoPorDiaYClasificacion(estacion.nombreEstacion + fecha.Year, fecha.ToString("yyyy/MM/dd"))));
        ...
        private void inicializarParametros(ReportParameter[] parametros)
        {
            ...
            parametros[17] = new ReportParameter("descripcion", "Sobrepeso por Día y Clasificación");
